...
public class MainActivity extends AppCompatActivity {
    ...
    private StressPredictor stressPredictor;
        ...
        predictButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    String prediction = stressPredictor.predictStressLevel(humidity, temperature, stepCount);
                    resultText.setText("Predicted Stress Level: " + prediction);

                    List<String> foodRecommendations = stressPredictor.getFoodRecommendations(MainActivity.this, prediction);
